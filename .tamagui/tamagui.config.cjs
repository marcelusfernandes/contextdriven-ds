...
var ref = /* @__PURE__ */ __name((value) => value, "ref");
var tokens = {
  /**
    ...
    size: {
      small: {
        input: {
          ...
          lineHeight: ref(primitive.typography.lineHeight.regular.small),
          iconPlateSize: ref(primitive.size[20]),
          iconPlateBorderRadius: ref(primitive.radius[16])
          // CIRCULAR!
        },
        single: {
          size: ref(primitive.size[20]),
...
// tamagui.config.ts
var tokens2 = (0, import_core.createTokens)({
  color: tokens.color,
  space: tokens.space,
  size: tokens.size,
...
var lightTheme = {
  ...
  shadowColor: tokens.color.blackAlpha20,
  shadowColorHover: tokens.color.blackAlpha50
};
var darkTheme = {
  ...
  shadowColor: tokens.color.blackAlpha80,
  shadowColorHover: tokens.color.blackAlpha80
};
var config = (0, import_core.createTamagui)({
  ...
  media: {
    xs: { maxWidth: tokens.breakpoint.xs },
    sm: { maxWidth: tokens.breakpoint.sm },
    md: { maxWidth: tokens.breakpoint.md },
    lg: { maxWidth: tokens.breakpoint.lg },
    xl: { maxWidth: tokens.breakpoint.xl },
    xxl: { maxWidth: tokens.breakpoint.xxl },
    gtXs: { minWidth: tokens.breakpoint.xs + 1 },
    gtSm: { minWidth: tokens.breakpoint.sm + 1 },
    gtMd: { minWidth: tokens.breakpoint.md + 1 },
    gtLg: { minWidth: tokens.breakpoint.lg + 1 },
    gtXl: { minWidth: tokens.breakpoint.xl + 1 },
    short: { maxHeight: 820 },
    tall: { minHeight: 820 },
  ...
  fonts: {
    body: {
      family: tokens.typography.fontFamily.body,
      size: {
        1: tokens.typography.fontSize.xs,
        2: tokens.typography.fontSize.sm,
        3: tokens.typography.fontSize.md,
        4: tokens.typography.fontSize.lg,
        5: tokens.typography.fontSize.xl,
        6: tokens.typography.fontSize.xxl,
        7: tokens.typography.fontSize.xxxl,
        8: tokens.typography.fontSize.h4,
        9: tokens.typography.fontSize.h3,
        10: tokens.typography.fontSize.h2,
        11: tokens.typography.fontSize.h1
      },
      lineHeight: {
        1: tokens.typography.lineHeight.xs,
        2: tokens.typography.lineHeight.sm,
        3: tokens.typography.lineHeight.md,
        4: tokens.typography.lineHeight.lg,
        5: tokens.typography.lineHeight.xl,
        6: tokens.typography.lineHeight.xxl,
        7: tokens.typography.lineHeight.xxxl
      },
      weight: {
        1: tokens.typography.fontWeight.regular,
        4: tokens.typography.fontWeight.regular,
        5: tokens.typography.fontWeight.medium,
        6: tokens.typography.fontWeight.semibold,
        7: tokens.typography.fontWeight.bold
      },
      letterSpacing: {
        1: tokens.typography.letterSpacing.tight,
        4: tokens.typography.letterSpacing.normal,
        7: tokens.typography.letterSpacing.wide
      }
    },
    heading: {
      family: tokens.typography.fontFamily.main,
      size: {
        1: tokens.typography.fontSize.h6,
        2: tokens.typography.fontSize.h5,
        3: tokens.typography.fontSize.h4,
        4: tokens.typography.fontSize.h3,
        5: tokens.typography.fontSize.h2,
        6: tokens.typography.fontSize.h1
      },
      lineHeight: {
        1: tokens.typography.lineHeight.md,
        2: tokens.typography.lineHeight.lg,
        3: tokens.typography.lineHeight.xl,
        4: tokens.typography.lineHeight.xxl,
        5: tokens.typography.lineHeight.xxxl,
        6: tokens.typography.lineHeight.xxxl
      },
      weight: {
        1: tokens.typography.fontWeight.semibold,
        6: tokens.typography.fontWeight.bold
      }
    }
  },
  animations: {
    fast: {
      type: "timing",
      duration: tokens.transition.duration.fast
    },
    normal: {
      type: "timing",
      duration: tokens.transition.duration.normal
    },
    slow: {
      type: "timing",
      duration: tokens.transition.duration.slow
    },
    bouncy: {
      type: "spring",
      damping: 10,
